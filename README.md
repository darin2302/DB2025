...
## ПРОЕКТИРАНЕ И РЕАЛИЗАЦИЯ НА БАЗА ДАННИ ЗА МАГАЗИН

**Автор:** [Вашето име]  
**Факултетен номер:** [Вашият номер]  
**Университет:** [Вашият университет]  
**Курс:** Бази данни  
**Дата:** Ноември 2024
...
> **[ПОСТАВИ ТУК СНИМКА НА ER ДИАГРАМАТА]**
> 
> Файл: `diagrams/ER_Diagram.png`

### 2.2 Ентитети и атрибути
...
> **[ПОСТАВИ ТУК СНИМКА НА ФИЗИЧЕСКИЯ МОДЕЛ]**
> 
> Файл: `diagrams/Physical_Model.png`
...
> **[ПОСТАВИ ТУК SCREENSHOT НА РЕЗУЛТАТА]**
...
Проектът успешно реализира всички изисквания на заданието:

- Нормализирана структура (3NF) без излишни данни
- Пълна функционалност за въвеждане, корекции и търсене на данни
- Оптимизация чрез 11 индекса и 1 view
- Референциална цялост чрез constraints
- Реалистични примерни данни за тестване (30 продажби)
- Детайлни справки (18 заявки) покриващи всички изисквания
- Документация на всички таблици и колони

### 9.2 Анализ на данните

**Най-печелившата категория:**
Електроника генерира 46.8% от оборота (10,447.93 лв) с високомаржинални продукти със средна цена 1,160.88 лв.

**Най-ефективен служител:**
Мария Димитрова (8 продажби, среден чек 979.24 лв)

**Най-ценен клиент:**
Анна Николова (4 покупки, общо 4,414.47 лв)

### 9.3 Възможности за разширение

Базата данни може да се разшири с:
- Онлайн поръчки (нова таблица ORDER с статус доставка)
- Инвентаризация (добавяне на QUANTITY в PRODUCT)
- Отстъпки и промоции (нова таблица DISCOUNT)
- Доставчици (нова таблица SUPPLIER + PRODUCT_SUPPLIER)
- Категории служители (permissions и roles)
- История на цени (audit таблица за промени в цени)

### 9.4 Технически характеристики

- СУБД: Oracle Database 12c или по-нова
- Размер на данни: ~50 KB (примерни данни)
- Брой таблици: 5
- Брой индекси: 11
- Брой constraints: 15+
- Нормална форма: 3NF
- Производителност: Оптимизирана за малки и средни обеми

---

## ПРИЛОЖЕНИЯ

### Приложение А: Файлова структура

```
databases/
├── 00_QUICK_START.md              - Кратко ръководство
├── 01_schema_design.md            - Теория и дизайн
├── 02_ddl_create_tables.sql       - DDL команди (CREATE)
├── 03_dml_sample_data.sql         - Примерни данни (INSERT)
├── 04_queries.sql                 - Всички заявки (SELECT)
├── 05_oracle_data_modeler_guide.md- Data Modeler ръководство
├── 06_expected_results.md         - Очаквани резултати
├── FINAL_DOCUMENTATION.md         - Този документ
├── HOW_TO_CREATE_DIAGRAMS.md      - Инструкции за диаграми
├── diagram.dbml                   - DBML код за диаграма
└── diagrams/                      - Диаграми
    ├── ER_Diagram.png
    └── Physical_Model.png
```

### Приложение Б: Използвани технологии

- База данни: Oracle Database 12c+
- SQL Dialect: Oracle PL/SQL
- Modeling tool: Oracle SQL Developer Data Modeler
- Документация: Markdown

### Приложение В: Източници

- Oracle Database Documentation: https://docs.oracle.com/database/
- Database Design Theory: "Database System Concepts" by Silberschatz
- SQL Best Practices: Oracle SQL Developer Data Modeler User Guide

---

**Декларация:**  
Декларирам, че представеният проект е изработен самостоятелно и всички използвани източници са цитирани.
